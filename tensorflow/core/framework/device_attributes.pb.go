...
// source: github.com/smoug25/tensorflow_serving_helper/tensorflow/core/framework/device_attributes.proto
...
func (*InterconnectLink) Descriptor() ([]byte, []int) {
	return fileDescriptor_60656e3d569d0bdc, []int{0}
}
...
func (*LocalLinks) Descriptor() ([]byte, []int) {
	return fileDescriptor_60656e3d569d0bdc, []int{1}
}
...
func (*DeviceLocality) Descriptor() ([]byte, []int) {
	return fileDescriptor_60656e3d569d0bdc, []int{2}
}
...
func (*DeviceAttributes) Descriptor() ([]byte, []int) {
	return fileDescriptor_60656e3d569d0bdc, []int{3}
}
...
func init() {
	proto.RegisterFile("github.com/smoug25/tensorflow_serving_helper/tensorflow/core/framework/device_attributes.proto", fileDescriptor_60656e3d569d0bdc)
}

var fileDescriptor_60656e3d569d0bdc = []byte{
	...
	,
}
